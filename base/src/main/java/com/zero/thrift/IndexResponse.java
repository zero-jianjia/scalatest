...
public class IndexResponse implements org.apache.thrift.TBase<IndexResponse, IndexResponse._Fields>, java.io.Serializable, Cloneable, Comparable<IndexResponse> {
  ...
  public List<SearchResp> result; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT, new org.apache.thrift.meta_data.FieldMetaData("result", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "SearchResp"))));
  ...
  public IndexResponse(IndexResponse other) {
    if (other.isSetResult()) {
      List<SearchResp> __this__result = new ArrayList<SearchResp>(other.result.size());
      for (SearchResp other_element : other.result) {
  ...
  public java.util.Iterator<SearchResp> getResultIterator() {
    return (this.result == null) ? null : this.result.iterator();
  }

  public void addToResult(SearchResp elem) {
    if (this.result == null) {
      this.result = new ArrayList<SearchResp>();
    }
    this.result.add(elem);
  }

  public List<SearchResp> getResult() {
    return this.result;
  }

  public IndexResponse setResult(List<SearchResp> result) {
    this.result = result;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT:
      if (value == null) {
        ...
        setResult((List<SearchResp>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new ArrayList<SearchResp>(_list0.size);
                SearchResp _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new SearchResp();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IndexResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (SearchResp _iter3 : struct.result)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (SearchResp _iter4 : struct.result)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.result = new ArrayList<SearchResp>(_list5.size);
          SearchResp _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new SearchResp();
            _elem6.read(iprot);
